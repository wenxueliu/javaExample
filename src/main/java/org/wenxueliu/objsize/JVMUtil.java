...
import static org.wenxueliu.objsize.UnsafeUtil.UNSAFE;
import static org.wenxueliu.objsize.UnsafeUtil.UNSAFE_AVAILABLE;
...
public final class JVMUtil {
    ...
    static boolean isCompressedOops() {
        ...
        log.info("Could not determine memory cost of reference; setting to default of 4 bytes.");
        return true;
    }
    ...
    static Boolean isHotSpotCompressedOopsOrNull() {
        try {
            ...
            log.info("Failed to read HotSpot specific configuration: " + e.getMessage());
        }
        return null;
    }
    ...
    private static final class ReferenceSizeEstimator {
        ...
        static Integer getReferenceSizeOrNull() {
            ...
            try {
                ...
                log.error("Could not determine cost of reference using field offsets: " + e.getMessage());
            }
